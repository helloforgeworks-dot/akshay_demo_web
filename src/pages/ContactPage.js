              ...
              <div class="tech-card">
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                  <div>
                    ...
                    <a href="mailto:${contact.email}" style="color: var(--brand-blue); font-family: var(--font-mono); font-size: clamp(0.9rem, 3.5vw, 1.05rem); font-weight: 700; word-break: break-all;">
                      ${contact.email}
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.35rem; margin-top: 0.25rem;">
                      <a href="tel:+919130303006" style="color: var(--text-primary); font-family: var(--font-mono); font-size: 0.95rem; font-weight: 700;">
                        +91 9130303006 (Sales & RFQ)
                      </a>
                      <a href="tel:+918956462142" style="color: var(--text-secondary); font-family: var(--font-mono); font-size: 0.9rem;">
