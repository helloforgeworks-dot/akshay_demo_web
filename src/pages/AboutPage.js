    ...
    <main class="page-content">
      ...
      <section class="section-py" style="background: #FFFFFF;">
        <div class="container">
          ...
          <div style="position: relative; display: flex; flex-direction: column; gap: 2rem; padding-left: 2rem; border-left: 2px solid var(--border-color); max-width: 900px; margin: 0 auto;">
            ${COMPANY_DATA.heritageTimeline.map((item) => `
              <div style="position: relative;">
                <!-- Timeline Dot -->
                <div style="position: absolute; left: -2.65rem; top: 1.5rem; width: 18px; height: 18px; border-radius: 50%; background: #FFFFFF; border: 3px solid var(--brand-blue); box-shadow: 0 0 8px rgba(11,58,102,0.2);"></div>

                <div style="background: var(--bg-secondary); border: 1px solid var(--border-color); padding: 2rem; border-radius: var(--border-radius-sm);">
                  <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.75rem; flex-wrap: wrap; gap: 0.5rem;">
                    <span style="font-family: var(--font-display); font-size: 1.6rem; font-weight: 800; color: var(--brand-blue);">
                      ${item.year}
                    </span>
                    <span class="tech-tag" style="font-size: 0.68rem; background: #FFFFFF;">${item.highlight}</span>
                  </div>

                  <h3 style="font-size: 1.3rem; margin-bottom: 0.25rem; color: var(--text-primary);">${item.title}</h3>
      ...
      <section class="section-py" style="background: var(--bg-secondary); border-top: 1px solid var(--border-color); border-bottom: 1px solid var(--border-color);">
        <div class="container">
          <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: clamp(2rem, 5vw, 4.5rem); align-items: center;">
            <div style="background: #FFFFFF; border: 1px solid var(--border-color); padding: 2.5rem; text-align: center; box-shadow: 0 8px 24px rgba(11,58,102,0.05);">
              <div style="width: 80px; height: 80px; border-radius: 50%; background: var(--bg-light-blue); border: 2px solid var(--brand-blue); display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem auto; color: var(--brand-blue);">
              ...
              <h3 style="font-size: 1.3rem; margin-bottom: 0.35rem; color: var(--text-primary);">Executive Leadership</h3>
              <div style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--brand-blue); text-transform: uppercase; font-weight: 700; margin-bottom: 1.25rem;">
            ...
            <div>
              ...
              <h2 style="font-size: clamp(1.9rem, 3.2vw, 2.7rem); line-height: 1.15; margin-bottom: 1.5rem; color: var(--text-primary);">
                A Pledge to Precision and Global Reliability
              </h2>
              <blockquote style="font-size: 1.05rem; line-height: 1.85; color: var(--text-primary); margin-bottom: 1.5rem; border-left: 3px solid var(--brand-blue); padding-left: 1.25rem;">
        ...
        <div class="container">
          <div style="display: grid; grid-template-columns: 1.1fr 1fr; gap: clamp(2rem, 5vw, 4.5rem); align-items: center;">
            <div>
              ...
              <h2 style="font-size: clamp(2rem, 3.5vw, 2.8rem); line-height: 1.15; margin-bottom: 1.5rem; color: var(--text-primary);">
                Shivleela Engineering: Breaking Stereotypes in CNC Machining
              </h2>
              <p style="font-size: 1rem; line-height: 1.8; margin-bottom: 1.25rem; color: var(--text-secondary);">
                ${COMPANY_DATA.careers.shivleelaStory}
              </p>
              <p style="font-size: 0.92rem; line-height: 1.8; margin-bottom: 2rem; color: var(--text-secondary);">
            ...
            <div style="background: #FFFFFF; border: 1px solid var(--border-color); padding: 2.25rem; box-shadow: 0 8px 24px rgba(11,58,102,0.06);">
              ...
              <div style="display: flex; flex-direction: column; gap: 1rem;">
                <div style="padding-bottom: 0.75rem; border-bottom: 1px solid var(--border-color);">
                  ...
                  <span style="font-size: 0.8rem; color: var(--text-secondary);">Dedicated CMM and optical profile measurement routines led by trained women engineers.</span>
                </div>
                <div style="padding-bottom: 0.75rem; border-bottom: 1px solid var(--border-color);">
                  <strong style="color: var(--text-primary); font-size: 0.9rem; display: block;">Vocational Apprenticeship in CNC/VMC</strong>
                  <span style="font-size: 0.8rem; color: var(--text-secondary);">Structured hands-on training in Fanuc/Siemens controllers, tool offset compensation, and GD&T.</span>
                </div>
                <div>
                  <strong style="color: var(--text-primary); font-size: 0.9rem; display: block;">Safe & Ergonomic Industrial Environment</strong>
                  <span style="font-size: 0.8rem; color: var(--text-secondary);">State-of-the-art mist collectors, automated pallet changers, and climate-controlled shopfloor.</span>
                </div>
              </div>
            </div>
          </div>
