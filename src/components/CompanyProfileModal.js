  ...
  return `
    <div class="modal-overlay" id="profile-modal-overlay">
      <div class="modal-box" id="profile-modal-box" style="max-width: 920px;">
        ...
        <div class="modal-body" id="printable-company-profile" style="background: #0B0D10; padding: 2.5rem; border: 1px solid var(--steel-border); margin: 1rem 0;">
          <!-- Document Header -->
          <div style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid var(--accent-bronze); padding-bottom: 1.5rem; margin-bottom: 2rem;">
            <div>
              <div style="font-family: var(--font-display); font-size: 1.6rem; font-weight: 800; letter-spacing: 0.04em;">
                PRIMELINE COMPONENTS PVT. LTD.
              </div>
              <div style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--accent-bronze); letter-spacing: 0.14em; text-transform: uppercase;">
            ...
            <div style="text-align: right; font-family: var(--font-mono); font-size: 0.72rem; color: var(--text-muted);">
              ...
              <div style="color: var(--status-green); font-weight: 600;">STATUS: VERIFIED TIER-1</div>
            </div>
          </div>
          ...
          <div style="margin-bottom: 2rem;">
            ...
            <p style="font-size: 0.9rem; color: var(--text-primary); line-height: 1.8;">
          ...
          <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 1rem; margin-bottom: 2rem; background: #13161C; padding: 1.25rem; border: 1px solid var(--steel-border);">
            <div>
              <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--text-muted);">GROUP HERITAGE</div>
              <div style="font-family: var(--font-display); font-size: 1.35rem; font-weight: 700; color: var(--accent-bronze);">25+ Years</div>
              <div style="font-size: 0.7rem; color: var(--text-secondary);">Founded 1996</div>
            </div>
            <div>
              <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--text-muted);">ADVANCED FLEET</div>
              <div style="font-family: var(--font-display); font-size: 1.35rem; font-weight: 700; color: var(--accent-bronze);">100+ Machines</div>
              <div style="font-size: 0.7rem; color: var(--text-secondary);">CNC / VMC / Lathes</div>
            </div>
            <div>
              <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--text-muted);">ENGINEERING TEAM</div>
              <div style="font-family: var(--font-display); font-size: 1.35rem; font-weight: 700; color: var(--accent-bronze);">100+ Staff</div>
              <div style="font-size: 0.7rem; color: var(--text-secondary);">QA & Programmers</div>
            </div>
            <div>
              <div style="font-family: var(--font-mono); font-size: 0.7rem; color: var(--text-muted);">TOLERANCE CAPABILITY</div>
              <div style="font-family: var(--font-display); font-size: 1.35rem; font-weight: 700; color: var(--accent-bronze);">±0.002 mm</div>
              <div style="font-size: 0.7rem; color: var(--text-secondary);">Zeiss CMM Certified</div>
            </div>
          </div>
          ...
          <div style="margin-bottom: 2rem;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
              <div style="background: #111317; border: 1px solid var(--steel-border); padding: 1rem;">
                ...
                <span style="font-size: 0.78rem; color: var(--text-muted);">Precision CNC Machined Parts, Assemblies & Moulded Components</span>
              </div>
              <div style="background: #111317; border: 1px solid var(--steel-border); padding: 1rem;">
                ...
                <span style="font-size: 0.78rem; color: var(--text-muted);">Automotive OEM Powertrain & High-Pressure Fluid Trim Conformance</span>
              </div>
            </div>
          </div>
          ...
          <div style="border-top: 1px solid var(--steel-border); padding-top: 1.5rem; display: flex; justify-content: space-between; align-items: center;">
            ...
            <div style="text-align: right; font-family: var(--font-mono); font-size: 0.75rem; color: var(--accent-bronze);">
  ...
  if (printBtn) {
    printBtn.addEventListener('click', () => {
      ...
      win.document.write(`
        ...
        .tech-tag { font-family: monospace; font-size: 11px; font-weight: bold; background: #eee; padding: 4px 8px; border: 1px solid #ccc; display: inline-block; }
      `);
