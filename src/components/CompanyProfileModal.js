        ...
        <div class="modal-body" id="printable-company-profile" style="background: #FFFFFF; padding: 2.5rem; border: 1px solid var(--border-color); margin: 1rem 0;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid var(--brand-blue); padding-bottom: 1.5rem; margin-bottom: 2rem;">
            <div>
              ...
              <div style="font-family: var(--font-mono); font-size: 0.75rem; color: var(--brand-blue); letter-spacing: 0.14em; text-transform: uppercase; font-weight: 700;">
                FORGEWORKS GROUP · SECTOR 16, NOIDA, UP, INDIA
              </div>
            ...
            <div style="text-align: right; font-family: var(--font-mono); font-size: 0.72rem; color: var(--text-muted);">
              <div>DOC REF: FWC-CORP-2026-V1</div>
          ...
          <div style="margin-bottom: 2rem;">
            ...
            <p style="font-size: 0.92rem; color: var(--text-primary); line-height: 1.8;">
              Forgeworks Components Pvt Ltd (FWC), led by Prince Singh (Founder & Managing Director), backed by 25+ years of combined manufacturing heritage, operates as a premier engineering-led manufacturing partner for global OEMs in Oil & Gas, Aerospace & Defence, Automobile, and Hydraulics.
            </p>
          </div>
          ...
          <div style="margin-bottom: 2rem;">
            <div class="tech-tag" style="margin-bottom: 0.75rem;">3.0 INFRASTRUCTURE & NOIDA / NCR CAMPUS</div>
            <div style="font-size: 0.85rem; color: var(--text-secondary); line-height: 1.8;">
              • <strong>Sector 16 Noida Plant 1:</strong> 35,000 sq. ft. heavy CNC/VMC machining hall, high-pressure oil & gas valve trim center, and hydrostatic test rig up to 700 bar.<br>
              • <strong>Noida Industrial Area Plant 2:</strong> 25,000 sq. ft. high-volume automotive powertrain and hydraulic spool machining center with cleanroom sub-assembly.<br>
              • <strong>NCR Precision Plant 3:</strong> 20,000 sq. ft. toolroom, plastics injection moulding presses (50T to 350T), and Shivleela Women's Skilled Engineering QA academy.
            </div>
          </div>
          ...
          <div style="border-top: 1px solid var(--border-color); padding-top: 1.5rem; display: flex; justify-content: space-between; align-items: center;">
            <div style="font-size: 0.82rem; color: var(--text-secondary);">
              <strong>Executive Contact:</strong> Prince Singh (Managing Director)<br>
              <strong>Direct RFQ Desk:</strong> helloforgeworks@gmail.com · +91 8810656549<br>
              <strong>Headquarters:</strong> Sector 16, Noida, Uttar Pradesh - 201301 India
            </div>
...
export function initCompanyProfileModalEvents() {
  ...
  if (printBtn) {
    printBtn.addEventListener('click', () => {
      ...
      win.document.write('<html><head><title>Forgeworks Components - Official Corporate Profile</title>');
